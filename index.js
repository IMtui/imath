...
const donet = "imath.com";
const owner = ["11111111111"]; // Put your number here ex: ["94xxxxxxxxx"]
const {
...
async function startHisoka() {
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("AI is Connected to IMT Server", "green"));
      console.log(color("Donate to Creator Imath", "yellow"));
